(() => {
  document.addEventListener("DOMContentLoaded", async function () {
    ...
    style.textContent = `
      ...
      .welo-logo-xr92 { height: 15px; width: 15px; margin: 0 2px; position: relative; top: -0.5px; }
      .welo-star-xr92 { height: 15px; width: 15px; margin-left: 2px; position: relative; top: -0.5px; }
